...
namespace MINIMAL_STD_NAMESPACE
{
    ...
    inline _MINIMAL_STD_HIDDEN _Size __loadword(const void *__p)
    {
        _Size __r;
    ...
    struct __murmur2_or_cityhash<_Size, 64>
    {
        ...
        operator()(const void *__key, _Size __len) const
        {
            ...
            _Size __z =
                __hash_len_16(__loadword<_Size>(__s + __len - 48) + __len, __loadword<_Size>(__s + __len - 24));
    ...
    private:
        ...
        _MINIMAL_STD_HIDDEN static _Size __rotate(_Size __val, int __shift)
        {
            return __shift == 0 ? __val : ((__val >> __shift) | (__val << (64 - __shift)));
        }

        _MINIMAL_STD_HIDDEN static _Size __rotate_by_at_least_1(_Size __val, int __shift)
        {
            return (__val >> __shift) | (__val << (64 - __shift));
        }

        _MINIMAL_STD_HIDDEN static _Size __shift_mix(_Size __val) { return __val ^ (__val >> 47); }

        _MINIMAL_STD_HIDDEN static _Size __hash_len_16(_Size __u, _Size __v)
        {
        ...
        _MINIMAL_STD_HIDDEN static _Size
        ...
        _MINIMAL_STD_HIDDEN static pair<_Size, _Size>
    ...
    {
        _MINIMAL_STD_HIDDEN size_t operator()(_Tp __v) const noexcept
        {
            union
            {
                _Tp __t;
    ...
    _MINIMAL_STD_HIDDEN inline size_t __hash_combine(size_t __lhs, size_t __rhs) noexcept
    {
    ...
    {
        _MINIMAL_STD_HIDDEN size_t operator()(bool __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<char> : public __unary_function<char, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(char __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<signed char> : public __unary_function<signed char, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(signed char __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<unsigned char> : public __unary_function<unsigned char, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(unsigned char __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<char8_t> : public __unary_function<char8_t, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(char8_t __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<char16_t> : public __unary_function<char16_t, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(char16_t __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<char32_t> : public __unary_function<char32_t, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(char32_t __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<wchar_t> : public __unary_function<wchar_t, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(wchar_t __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<short> : public __unary_function<short, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(short __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<unsigned short> : public __unary_function<unsigned short, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(unsigned short __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<int> : public __unary_function<int, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(int __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<unsigned int> : public __unary_function<unsigned int, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(unsigned int __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<long> : public __unary_function<long, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(long __v) const noexcept { return static_cast<size_t>(__v); }
    };

    template <>
    struct hash<unsigned long> : public __unary_function<unsigned long, size_t>
    {
        _MINIMAL_STD_HIDDEN size_t operator()(unsigned long __v) const noexcept
        {
    ...
    {
        _MINIMAL_STD_HIDDEN size_t operator()(float __v) const noexcept
        {
    ...
    {
        _MINIMAL_STD_HIDDEN size_t operator()(double __v) const noexcept
        {
            // -0.0 and 0.0 should return same hash
            if (__v == 0.0)
                return 0;
    ...
    {
        _MINIMAL_STD_HIDDEN size_t operator()(long double __v) const noexcept
        {
            // -0.0 and 0.0 should return same hash
            if (__v == 0.0L)
                return 0;
    ...
    {
        _MINIMAL_STD_HIDDEN size_t operator()(nullptr_t) const noexcept { return 662607004ull; }
    };

    template <class _Key, class _Hash>
    using __check_hash_requirements _MINIMAL_STD_NODEBUG =
        integral_constant<bool,
                          is_copy_constructible<_Hash>::value && is_move_constructible<_Hash>::value &&
                              __invokable_r<size_t, _Hash, _Key const &>::value>;

    template <class _Key, class _Hash = hash<_Key>>
    using __has_enabled_hash _MINIMAL_STD_NODEBUG =
        integral_constant<bool, __check_hash_requirements<_Key, _Hash>::value && is_default_constructible<_Hash>::value>;

    template <class _Type, class>
    using __enable_hash_helper_imp _MINIMAL_STD_NODEBUG = _Type;

    template <class _Type, class... _Keys>
    using __enable_hash_helper _MINIMAL_STD_NODEBUG =
