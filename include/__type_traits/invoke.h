...
inline _MINIMAL_STD_HIDDEN constexpr
decltype((declval<_A0>().*declval<_Fp>())(declval<_Args>()...))
...
inline _MINIMAL_STD_HIDDEN constexpr
decltype((declval<_A0>().get().*declval<_Fp>())(declval<_Args>()...))
__invoke(_Fp&& __f, _A0&& __a0, _Args&&... __args)
...
inline _MINIMAL_STD_HIDDEN constexpr
decltype(declval<_A0>().*declval<_Fp>())
...
inline _MINIMAL_STD_HIDDEN constexpr
decltype(declval<_A0>().get().*declval<_Fp>())
__invoke(_Fp&& __f, _A0&& __a0)
...
inline _MINIMAL_STD_HIDDEN constexpr
decltype(declval<_Fp>()(declval<_Args>()...))
__invoke(_Fp&& __f, _Args&&... __args)
    ...
    struct __invokable_r
    {
        ...
        static decltype(__invoke(declval<_XFp>(), declval<_XArgs>()...)) __try_call(int);
        template <class _XFp, class... _XArgs>
    ...
    struct __nothrow_invokable_r_imp<true, false, _Ret, _Fp, _Args...>
    {
        ...
        static const bool value =
            noexcept(_ThisT::__test_noexcept<_Ret>(__invoke(declval<_Fp>(), declval<_Args>()...)));
    };
    ...
    {
        template <class... _Args>
        _MINIMAL_STD_HIDDEN constexpr static _Ret __call(_Args &&...__args)
        {
            return __invoke(forward<_Args>(__args)...);
        }
    };
    ...
    {
        template <class... _Args>
        _MINIMAL_STD_HIDDEN constexpr static void __call(_Args &&...__args)
        {
            __invoke(forward<_Args>(__args)...);
        }
    };
