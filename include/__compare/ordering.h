...
namespace MINIMAL_STD_NAMESPACE
{
    ...
    struct _CmpUnspecifiedParam
    {
        ...
        _MINIMAL_STD_HIDDEN consteval _CmpUnspecifiedParam(_Tp __zero) noexcept
    ...
    class partial_ordering
    {
        _MINIMAL_STD_HIDDEN explicit constexpr partial_ordering(_PartialOrdResult __v) noexcept : __value_(__v) {}
    ...
    public:
        ...
        // comparisons
        _MINIMAL_STD_HIDDEN friend constexpr bool operator==(partial_ordering, partial_ordering) noexcept = default;

        _MINIMAL_STD_HIDDEN friend constexpr bool operator==(partial_ordering __v, _CmpUnspecifiedParam) noexcept
        {
        ...
        _MINIMAL_STD_HIDDEN friend constexpr bool operator<(_CmpUnspecifiedParam, partial_ordering __v) noexcept
        {
            return __v.__value_ == _PartialOrdResult::__greater;
        }
        ...
        _MINIMAL_STD_HIDDEN friend constexpr partial_ordering
    ...
    class weak_ordering
    {
        ...
        _MINIMAL_STD_HIDDEN explicit constexpr weak_ordering(_OrdResult __v) noexcept : __value_(_ValueT(__v)) {}
    ...
    public:
        ...
        _MINIMAL_STD_HIDDEN constexpr operator partial_ordering() const noexcept
        {
        ...
        // comparisons
        _MINIMAL_STD_HIDDEN friend constexpr bool operator==(weak_ordering, weak_ordering) noexcept = default;

        _MINIMAL_STD_HIDDEN friend constexpr bool operator==(weak_ordering __v, _CmpUnspecifiedParam) noexcept
        {
        ...
        _MINIMAL_STD_HIDDEN friend constexpr bool operator<(_CmpUnspecifiedParam, weak_ordering __v) noexcept
        {
        ...
        _MINIMAL_STD_HIDDEN friend constexpr weak_ordering operator<=>(weak_ordering __v, _CmpUnspecifiedParam) noexcept
        {
            return __v;
        }

        _MINIMAL_STD_HIDDEN friend constexpr weak_ordering operator<=>(_CmpUnspecifiedParam, weak_ordering __v) noexcept
        {
    ...
    class strong_ordering
    {
        ...
        _MINIMAL_STD_HIDDEN explicit constexpr strong_ordering(_OrdResult __v) noexcept : __value_(_ValueT(__v)) {}
    ...
    public:
        ...
        _MINIMAL_STD_HIDDEN constexpr operator weak_ordering() const noexcept
        {
            return __value_ == 0 ? weak_ordering::equivalent : (__value_ < 0 ? weak_ordering::less : weak_ordering::greater);
        }

        // comparisons
        _MINIMAL_STD_HIDDEN friend constexpr bool operator==(strong_ordering, strong_ordering) noexcept = default;

        _MINIMAL_STD_HIDDEN friend constexpr bool operator==(strong_ordering __v, _CmpUnspecifiedParam) noexcept
        {
            return __v.__value_ == 0;
        }
        ...
        _MINIMAL_STD_HIDDEN friend constexpr bool operator<(_CmpUnspecifiedParam, strong_ordering __v) noexcept
        {
            return 0 < __v.__value_;
        }
        ...
        _MINIMAL_STD_HIDDEN friend constexpr strong_ordering
